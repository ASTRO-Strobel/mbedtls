 ...
 *
 * \warning As of 1.3.11, *not* using this flag when MBEDTLS_NET_C is
 ...
 */
#define MBEDTLS_ERROR_STRERROR_BC
 ...
 */
#define MBEDTLS_SSL_ALERT_MESSAGES
 ...
 *
 */
#ifdef CYGNUM_MBEDTLS_DEBUG_ENABLE
...
/**
 * \def MBEDTLS_SSL_DISABLE_RENEGOTIATION
 *
 ...
 * MBEDTLS_SSL_RENEGOTIATION to enable support for renegotiation.
 *
 * Uncomment this to disable support for renegotiation.
 */
//#define MBEDTLS_SSL_DISABLE_RENEGOTIATION
...
/**
 * \def MBEDTLS_SSL_ENABLE_MD5_SIGNATURES
 *
 ...
 */
//#define MBEDTLS_SSL_ENABLE_MD5_SIGNATURES
...
/**
 * \def MBEDTLS_MEMORY_C
 *
 * \deprecated Use MBEDTLS_PLATFORM_MEMORY instead.
 *
 * Depends on: MBEDTLS_PLATFORM_C
 */
//#define MBEDTLS_MEMORY_C
 ...
 * MBEDTLS_HAVE_IPV6. The alternative legacy code will be removed in 2.0.
 *
...
/**
 * \def MBEDTLS_PBKDF2_C
 *
 * Enable PKCS#5 PBKDF2 key derivation function.
 *
 * \deprecated Use MBEDTLS_PKCS5_C instead
 *
 ...
 *           and at least one of the MBEDTLS_SSL_PROTO_* defines
 *
...
/* Debug options */
#define MBEDTLS_DEBUG_DFL_MODE MBEDTLS_DEBUG_LOG_RAW /**< Default log: Full or Raw */
